...
import { Copy, Share2, Code, Terminal } from "lucide-react"
      ...
      <div className="flex flex-col min-h-screen">
        <main className="flex-1 p-4 md:p-6 overflow-hidden">
          <div className="w-full max-w-6xl mx-auto space-y-6">
            ...
            <motion.div
              className="border border-gray-800 rounded-xl overflow-hidden shadow-xl bg-gray-900/30 backdrop-blur-sm"
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.5 }}
            >
              <div className="bg-gray-800/50 p-3 flex flex-wrap justify-between items-center gap-2 border-b border-gray-700/50">
                <div className="flex space-x-3">
                  <button
                    className="px-4 py-2 bg-gray-900/70 hover:bg-gray-900 rounded-md text-gray-300 transition-colors duration-200 flex items-center"
                    onClick={handleCopy}
                  >
                  ...
                  <button
                    className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 rounded-md text-white transition-colors duration-200 flex items-center shadow-lg shadow-cyan-500/10"
                    onClick={handleShare}
                  >
              ...
              <div className="relative bg-gray-950 text-gray-100 font-mono text-sm overflow-hidden">
                <div className="absolute top-0 left-0 h-full bg-gray-900/50 border-r border-gray-800/50 flex flex-col items-end pt-4 text-gray-500 select-none">
                  {lines.map((_, index) => (
                ...
                <div className="relative">
                  ...
                  <textarea
                    ref={textareaRef}
                    className="absolute top-0 left-0 w-full h-full bg-transparent text-transparent caret-white resize-none focus:outline-none focus:ring-1 focus:ring-cyan-500/30 p-4 pl-16"
                    value={sharedCode}
            ...
            <motion.div
              className="bg-gray-900/30 backdrop-blur-sm p-6 rounded-xl border border-gray-800 shadow-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">Collaboration Tips</h3>
                  <ul className="text-gray-400 text-sm list-disc list-inside">
                    <li>
                      Share the URL with your team members to collaborate in real-time. All changes are automatically
                      saved and synced across all connected devices.
                    </li>
                    <li>
                      Use the &quot;Share Snippet&quot; button to generate a shareable link to access your code later.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <AnimatePresence>
          {toastMessage && (
            <motion.div
              className="fixed bottom-4 right-4 bg-gradient-to-r from-cyan-600 to-teal-600 text-white p-3 rounded-lg shadow-lg"
